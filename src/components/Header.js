...
const mobileMenuToggle=()=>{
  ...
  return (
    <div className='sticky top-0 z-10 flex flex-row justify-between items-center h-14 px-4 md:px-5 bg-black dark:bg-black'>
{loading&&<Loader/>}
...
</div> <button className='w-[40px] md:w-[60px] h-8 md:h-10 flex items-center justify-center border-l-0 border-[#303030] rounded-r-3xl bg-white/[0.1]'>
    <IoIosSearch className='text-white text-xl'/>
  </button>
...
<FiBell className='text-white text-xl cursor-pointer'/>
      ...
      <div className='flex h-8 w-8 overflow-hidden rounded-full md:ml-4'>
        <img src='https://xsgames.co/randomusers/assets/avatars/male/22.jpg' alt='profile'/>
      </div>
    </div>
